...
public class Fisica extends AppCompatActivity {
    public static double sumaFisica= 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(validar()){
                    sumaFisica= (Float.parseFloat(parcial1.getText().toString())+Float.parseFloat(parcial2.getText().toString())+Float.parseFloat(parcial3.getText().toString()))/3;

                    if(sumaFisica!=0){  //se ha ingresado algo
                        prom.setText("Promedio "+String.valueOf(df.format(sumaFisica)));
